...
export function StoreBasics({
  ...
  }, [selectedCountry, availableStates, watch, setValue]);
  ...
  return (
    <>
      ...
      <div>
        ...
        <select
          {...register('country', { onBlur })}
          className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
        >
          <option value="">{t('onboarding.form.selectCountry')}</option>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          >
            <option value="">{selectedCountry ? t('onboarding.form.selectState') : t('onboarding.form.selectCountryFirst')}</option>
